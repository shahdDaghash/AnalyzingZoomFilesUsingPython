                    ...
                    for dataLine in csv_reader:
                        if lineCount >= 1:
                            ...
                            for studentIDNumber in self.getStudentList():
                                ...
                                if (numOfMatches == len(studentNameList) or isNumberCheck) and int(dataLine[1]) >= p:
                    ...
                    if len(messageLineList) > 2:
                        ...
                        if firstTime + TBTime <= timeOfMessage <= lastTime - TETime:
                            ...
                            for studentIDNumber in self.getStudentList():
                                ...
                                if (numOfMatches == len(studentNameList) or isNumberCheck) and studentIDNumber not in \
                                ...
                                elif numOfMatches == len(studentNameList) or isNumberCheck:
                                    self.getChatList()[dateOFFile][studentIDNumber] += 1
                                    nameFound = True
